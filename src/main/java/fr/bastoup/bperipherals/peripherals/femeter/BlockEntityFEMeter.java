...
public class BlockEntityFEMeter extends BlockEntityPeripheral {
    ...
    public BlockEntityFEMeter(BlockPos pos, BlockState state) {
    ...
    public static <T extends BlockEntity> void tick(Level level, BlockPos blockPos, BlockState blockState, T tile) {
        if(!(tile instanceof BlockEntityFEMeter))
            return;

        BlockEntityFEMeter blockEntity = (BlockEntityFEMeter) tile;
